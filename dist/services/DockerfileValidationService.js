...
exports.DockerfileValidationService = void 0;
const child_process_1 = require("child_process");
const util_1 = require("util");
const execAsync = (0, util_1.promisify)(child_process_1.exec);
class DockerfileValidationService {
    async validateDockerfile(dockerfile) {
        const errors = [];
        const warnings = [];
        const suggestions = [];
        try {
    ...
    async validateSyntax(dockerfile) {
        const errors = [];
        const warnings = [];
    ...
    async validateSecurity(dockerfile) {
        const errors = [];
        const warnings = [];
        const suggestions = [];
        const lines = dockerfile.split('\n');
    ...
    async validateBestPractices(dockerfile) {
        const warnings = [];
        const suggestions = [];
        const lines = dockerfile.split('\n');
    ...
    async validatePerformance(dockerfile) {
        const warnings = [];
        const suggestions = [];
        const lines = dockerfile.split('\n');
        let copyOrder = 0;
    ...
    async validateWithDockerLint(dockerfile) {
        try {
...
exports.DockerfileValidationService = DockerfileValidationService;
//# sourceMappingURL=DockerfileValidationService.js.map